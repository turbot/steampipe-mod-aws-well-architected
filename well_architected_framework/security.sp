...
locals {
  well_architected_framework_security_sec01_common_tags = merge(local.well_architected_framework_security_common_tags, {
    question_id = "securely-operate"
  })
  well_architected_framework_security_sec02_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec01" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec01_bp01,
    benchmark.well_architected_framework_security_sec01_bp02
  ]

  tags = local.well_architected_framework_security_sec01_common_tags
}
...
benchmark "well_architected_framework_security_sec01_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec01_common_tags, {
...
benchmark "well_architected_framework_security_sec02" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec02_bp01,
    benchmark.well_architected_framework_security_sec02_bp02
  ]

  tags = local.well_architected_framework_security_sec02_common_tags
}
...
benchmark "well_architected_framework_security_sec02_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec02_common_tags, {
