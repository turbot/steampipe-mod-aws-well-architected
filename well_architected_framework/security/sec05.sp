locals {
  well_architected_framework_security_sec05_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec05" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec05_bp01,
    benchmark.well_architected_framework_security_sec05_bp02,
    benchmark.well_architected_framework_security_sec05_bp03,
    benchmark.well_architected_framework_security_sec05_bp04
  ]

  tags = local.well_architected_framework_security_sec05_common_tags
}
...
benchmark "well_architected_framework_security_sec05_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec05_common_tags, {
