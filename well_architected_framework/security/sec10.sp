locals {
  well_architected_framework_security_sec10_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec10" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec10_bp01
  ]

  tags = local.well_architected_framework_security_sec10_common_tags
}
...
benchmark "well_architected_framework_security_sec10_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec10_common_tags, {
