locals {
  well_architected_framework_security_sec03_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec03" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec03_bp01,
    benchmark.well_architected_framework_security_sec03_bp02,
    benchmark.well_architected_framework_security_sec03_bp03,
    benchmark.well_architected_framework_security_sec03_bp04,
    benchmark.well_architected_framework_security_sec03_bp05,
    benchmark.well_architected_framework_security_sec03_bp06,
    benchmark.well_architected_framework_security_sec03_bp07,
    benchmark.well_architected_framework_security_sec03_bp08
  ]

  tags = local.well_architected_framework_security_sec03_common_tags
}
...
benchmark "well_architected_framework_security_sec03_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec03_common_tags, {
