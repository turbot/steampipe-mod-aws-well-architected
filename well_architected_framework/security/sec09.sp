locals {
  well_architected_framework_security_sec09_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec09" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec09_bp01,
    benchmark.well_architected_framework_security_sec09_bp02,
    benchmark.well_architected_framework_security_sec09_bp03,
    benchmark.well_architected_framework_security_sec09_bp04
  ]

  tags = local.well_architected_framework_security_sec09_common_tags
}
...
benchmark "well_architected_framework_security_sec09_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec09_common_tags, {
