locals {
  well_architected_framework_security_sec11_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec11" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec11_bp02
  ]

  tags = local.well_architected_framework_security_sec11_common_tags
}
...
benchmark "well_architected_framework_security_sec11_bp02" {
  ...
  tags = merge(local.well_architected_framework_security_sec11_common_tags, {
