locals {
  well_architected_framework_security_sec04_common_tags = merge(local.well_architected_framework_security_common_tags, {
...
benchmark "well_architected_framework_security_sec04" {
  ...
  children = [
    benchmark.well_architected_framework_security_sec04_bp01,
    benchmark.well_architected_framework_security_sec04_bp02,
    benchmark.well_architected_framework_security_sec04_bp03
  ]

  tags = local.well_architected_framework_security_sec04_common_tags
}
...
benchmark "well_architected_framework_security_sec04_bp01" {
  ...
  tags = merge(local.well_architected_framework_security_sec04_common_tags, {
